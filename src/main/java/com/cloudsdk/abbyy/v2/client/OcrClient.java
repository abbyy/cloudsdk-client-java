...
package com.cloudsdk.abbyy.v2.client;

import com.cloudsdk.abbyy.v2.client.http.HttpAsyncClient;
import com.cloudsdk.abbyy.v2.client.http.HttpAsyncRequest;
import com.cloudsdk.abbyy.v2.client.http.HttpAsyncResponse;
import com.cloudsdk.abbyy.v2.client.http.HttpRequestMethod;
import com.cloudsdk.abbyy.v2.client.models.Error;
import com.cloudsdk.abbyy.v2.client.models.*;
import com.cloudsdk.abbyy.v2.client.models.requestparams.*;
...
public class OcrClient implements IOcrClient {
        ...
        if (response.getStatusCode() == HttpAsyncResponse.STATUS_CODE_OK) {
            try {
                ...
                throw new ApiException(
                        ...
                        com.cloudsdk.abbyy.v2.client.models.Error.fromText(responseData),
                        response.getHeaders(),
                        exception);
            }
        }
    ...
    private com.cloudsdk.abbyy.v2.client.models.Error tryDeserializeError(String responseData) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            return mapper.readValue(responseData, com.cloudsdk.abbyy.v2.client.models.Error.class);
        }
        catch (Exception e) {
